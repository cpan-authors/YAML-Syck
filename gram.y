...
%code provides {
    /* Match the actual definition in token.c */
...
%type <nodeData>    doc atom ind_rep atom_or_empty empty word_rep struct_rep
%type <nodeId>      basic_seq
%type <nodeData>    implicit_seq top_imp_seq in_implicit_seq
%type <nodeData>    inline_seq in_inline_seq inline_seq_atom
...
implicit_seq
        : indent_open top_imp_seq indent_end
        {
                    $$ = $2;
                }
...
top_imp_seq
        : YAML_TRANSFER indent_sep in_implicit_seq
        {
...
implicit_map
        : indent_open top_imp_map indent_end
        {
...
top_imp_map
        : YAML_TRANSFER indent_sep in_implicit_map
        {
                    syck_add_transfer( $1, $3, ((SyckParser *)parser)->taguri_expansion );
                    $$ = $3;
                }
